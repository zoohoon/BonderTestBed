...
namespace CUI
{
    public class RadioButton : System.Windows.Controls.RadioButton, INotifyPropertyChanged, IFactoryModule, ICUIControl
    {
            ...
            try
            {
                ...
                else
                {
                    if (this.ContextMenu != null)
                    {
                        ...
                        {
                            int HighestLevel = 0;
                            HighestLevel = AccountManager.MaskingLevelCollection.Max();

                            if (HighestLevel == AccountManager.CurrentUserInfo.UserLevel)
                            {
        ...
        protected override void OnClick()
        {
            try
            {
                String log = $"{this.GetType().Name.ToString()} GUID:{GUID.ToString()} | OnClick";
