...
namespace ServiceProxy
{
    ...
    public class StageMoveProxy : ClientBase<IStageMove>, IStageMoveProxy, IFactoryModule
    {
        ...
        public EventCodeEnum WaferHighViewMove_Wafer(double xpos, double ypos, EnumTrjType trjtype = EnumTrjType.Normal, double ovrd = 1)
        {
            ...
            if (IsOpened())
            {
                retVal = Channel.WaferHighViewMove_Wafer(xpos, ypos, trjtype, ovrd);
            }
            return retVal;
        }
        ...
        // 260116 sebas
        public EventCodeEnum WaferLowViewMove_Wafer(double xpos, double ypos, double zpos, bool NotUseHeightProfile = false, EnumTrjType trjtype = EnumTrjType.Normal, double ovrd = 1)
        {
            EventCodeEnum retVal = EventCodeEnum.UNDEFINED;
            if (IsOpened())
            {
                retVal = Channel.WaferLowViewMove_Wafer(xpos, ypos, zpos, NotUseHeightProfile, trjtype, ovrd);
            }
            return retVal;
        }
