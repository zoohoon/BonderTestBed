...
{
    public class ParamToSourceConverter : IValueConverter
    {
    ...
    public static class NodeConverter
    {
        ...
        public static Node CreateGroupNode(Node parentNode, object instance, object ownerInstance, string nodeName, bool canWrite)
        {
            ...
            else if (instType == typeof(Guid))
            {
                GUIDNode guidNode = new GUIDNode(parentNode);
                guidNode.Text = nodeName;
                guidNode.OwnerInstance = ownerInstance;
                guidNode.PropertyName = nodeName;
