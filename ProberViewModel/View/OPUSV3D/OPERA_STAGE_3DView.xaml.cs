...
{
    /// <summary>
    /// OPERA_STAGE_3DView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class OPERA_STAGE_3DView : UserControl, IMainScreenView, IDisposable
    {
        ...
        private IRemoteMediumProxy _RemoteMedium;
        public IRemoteMediumProxy RemoteMedium
        {
            get { return _RemoteMedium; }
            set
            {
                if (value != _RemoteMedium)
                {
                    _RemoteMedium = value;
                    RaisePropertyChanged();
                }
        ...
        public OPERA_STAGE_3DView(IMotionManager motion, IRemoteMediumProxy remoteMedium)
        {
            InitializeComponent();
            DataContext = this;
            CenterViewChange();
            ...
            Motion = motion;
            LoaderController = this.LoaderController() as ILoaderControllerExtension;
            RemoteMedium = remoteMedium;
            if (Motion != null)
            {
                MotionManagerServiceClient motionManagerClient = Motion as MotionManagerServiceClient;
                motionManagerClient.motionPosDelegate += SetAxis;
            }
            MonitoringManager = new MonitoringManager();
            if (Motion != null)
            {
            ...
            if (RemoteMedium != null)
            {
                //var vacuumStatus = RemoteMedium.GPCC_OP_GetCCVacuumStatus();
                //IsWaferBridgeExtended = new IOPortDescripter<bool>();
                //IsWaferBridgeExtended.Value = vacuumStatus.IsCamExtended;
            }
