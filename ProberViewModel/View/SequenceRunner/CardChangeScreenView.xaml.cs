...
{
    public partial class CardChangeScreenView : UserControl, IMainScreenView
    {
        readonly Guid _ViewGUID = new Guid("0922A4D5-D811-425D-A68F-6CE5A210102B");
        public Guid ScreenGUID { get { return _ViewGUID; } }

        public CardChangeScreenView()
        {
            InitializeComponent();
        }
    }
