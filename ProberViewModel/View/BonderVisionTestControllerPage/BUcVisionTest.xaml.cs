...
namespace BVisionTestView
{
    /// <summary>
    /// UcVisionTest.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class BUcVisionTest : UserControl, IMainScreenView, IFactoryModule
    {
        public BUcVisionTest()
        {
            try
            {
                InitializeComponent();
        ...
        readonly Guid _ViewGUID = new Guid("367FF140-F606-B65B-7C17-1A743AD06ED7");
