...
namespace SystemSettingMainViewModel
{
    public class SystemSettingMainVM : IMainScreenViewModel
    {
        private Guid _ViewModelGUID = new Guid("D34C35D7-5C00-CBE0-20B6-D424137D2E18");
        ...
        //private LockKey findLockObj = new LockKey($"SystemSettingMainViewModel : Finder Lock Key.");
        private object findLockObj = new object();

        private void FindSearchCategory(string searchData)
        {
            ...
            try
            {
                //using (Locker locker = new Locker(findLockObj))
                //{
