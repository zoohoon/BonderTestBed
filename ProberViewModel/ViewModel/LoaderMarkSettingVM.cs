...
namespace LoaderMarkSettingViewModel
{
    public class LoaderMarkSettingVM : IMarkSettingVM
    {
        ...
        readonly Guid _ViewModelGUID = new Guid("f6dc73b3-56cb-424e-bc34-1ec713cb7299");
