...
{
    public class FileSystemVM : IMainScreenViewModel, IParamScrollingViewModel
    {
        ...
        private readonly Guid _ViewModelGUID = new Guid("7c1326fc-580e-4ede-a8a4-287387402b74");
