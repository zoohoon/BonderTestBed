...
namespace TesterCommunicationSettingViewModel
{
    ...
    public class TesterCommunicationSettingViewModel : IMainScreenViewModel, IParamScrollingViewModel
    {
        ...
        private const int _CatID = 30005;
        public bool Initialized { get; set; } = false;

        private readonly Guid _ViewModelGUID = new Guid("f0adaa33-a1c7-4f3d-9e92-1558ff08ad70");
