...
namespace MachineSettingStageViewModel
{
    using CUIServices;
    using LogModule;
    ...
    public class MachineSettingStageViewModel : IMainScreenViewModel
    {
        private readonly Guid _ViewModelGUID = new Guid("928e13af-714d-44c1-9ee7-6894a7f88848");
