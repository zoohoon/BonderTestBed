...
{
    public class WaferAlignSysSubViewModel : IMainScreenViewModel, IParamScrollingViewModel
    {
        ...
        private int _CategoryID = 10033;

        #region ==> IMainScreenViewModel
        private readonly Guid _ViewModelGUID = new Guid("2C284C1F-CCBD-4E1F-800E-7BA2B365A208");
