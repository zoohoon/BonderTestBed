...
namespace SoakingSystemViewModel
{
    public class SoakingSystemVM : IMainScreenViewModel, IParamScrollingViewModel
    {
        ...
        private readonly Guid _ViewModelGUID = new Guid("642A7F27-C9B8-4FEF-BB9F-5FCB8BD96F71");
