...
namespace SamplePinAlignSetteingVM
{
    public class SamplePinAlignSettingViewModel : IMainScreenViewModel
    {
        private Guid _ViewModelGUID = new Guid("80FEF0BE-3C35-45D2-BD1A-05F80557BA80");
        ...
        public EventCodeEnum SaveParameter()
        {
            ...
            try
            {
                ...
                {
                    LoggerManager.Error("[SamplePinAlignSettingViewModel] Parameter Save Fail!");
                }
            }
            catch (Exception err)
            {
