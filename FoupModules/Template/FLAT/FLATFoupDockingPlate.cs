...
{
    public class FLATFoupDockingPlate : FoupDockingPlateBase, ITemplateModule
    {
        private FLATFoupDockingPlateStateBase _State;

        public FLATFoupDockingPlateStateBase State
        {
            get { return _State; }
            set { _State = value; }
        }

        public FLATFoupDockingPlate()
        {
        ...
        #endregion
        public FLATFoupDockingPlate(FoupModule module) : base(module)
        {
            StateInit();
        }

        public void StateTransition(FLATFoupDockingPlateStateBase state)
        {
            try
            {
                _State = state;
        ...
        public override EventCodeEnum StateInit()
        {
            ...
            try
            {
                if (Module.DeviceParam.SubstrateSize.Value == SubstrateSizeEnum.INCH6)
                {
                    ...
                    if (ret != 0)
                    {
                        State = new FLATFoupDockingPlateStateError(this);
                    }
                    else
                    {
                        if (PLACEMENT_6Inch_value == true)
                        {
                            if (PRESENCE_6_8Inch_value != true)
                            {
                                ...
                                {
                                    State = new FLATFoupDockingPlateStateUnLock(this);
                                }
                                else
                                {
                                    State = new FLATFoupDockingPlateStateError(this);
                            ...
                            else
                            {
                                ...
                                State = new FLATFoupDockingPlateStateLock(this);
                            }
                        }
                        else
                        {
                ...
                else if (Module.DeviceParam.SubstrateSize.Value == SubstrateSizeEnum.INCH12)
                {
                    ...
                    if (ret == 0)
                    {
                        StateTransition(new FLATFoupDockingPlateStateUnLock(this));
                    }
                    else if (ret == -2)
                    {
                        ...
                        if (ret2 == 0)
                        {
                            StateTransition(new FLATFoupDockingPlateStateLock(this));
                        }
                        else
                        {
                            StateTransition(new FLATFoupDockingPlateStateError(this));
                        }
                    }
                    else
                    {
    ...
    public abstract class FLATFoupDockingPlateStateBase
    {
        public FLATFoupDockingPlateStateBase(FLATFoupDockingPlate owner)
        {
            this.Owner = owner;
        }

        private FLATFoupDockingPlate _Owner;
        public FLATFoupDockingPlate Owner
        {
            get { return _Owner; }
            set
            {
                       ...
                       Owner.Module.DeviceParam.SubstrateSize.Value == SubstrateSizeEnum.INCH8)
                    {
                        ...
                        if (retIOvalue == 0)
                        {
                            ...
                            if (retIOvalue == 0)
                            {
                                ...
                                if (retIOvalue == 0)
                                {
                                    Owner.StateTransition(new FLATFoupDockingPlateStateLock(Owner));
                                }
                                else
                                {
                                    // TODO : Why Retract function is called?
                                    retIOvalue = DockingPlateCylinder.Retract();
                                    Owner.StateTransition(new FLATFoupDockingPlateStateError(Owner));
                                }
                            }
                        }
                        ...
                        else if (retIOvalue == -2)
                        {
                            ...
                            if (retIOvalue == 0)
                            {
                                ...
                                if (retIOvalue == 0)
                                {
                                    ...
                                    if (retIOvalue == 0)
                                    {
                                        Owner.StateTransition(new FLATFoupDockingPlateStateUnLock(Owner));
                                    }
                                    else
                                    {
                                        Owner.StateTransition(new FLATFoupDockingPlateStateError(Owner));
    ...
    public class FLATFoupDockingPlateStateLock : FLATFoupDockingPlateStateBase
    {
        public FLATFoupDockingPlateStateLock(FLATFoupDockingPlate owner) : base(owner)
        {
        }
    ...
    public class FLATFoupDockingPlateStateUnLock : FLATFoupDockingPlateStateBase
    {
        public FLATFoupDockingPlateStateUnLock(FLATFoupDockingPlate owner) : base(owner)
        {
        }
    ...
    public class FLATFoupDockingPlateStateError : FLATFoupDockingPlateStateBase
    {
        public FLATFoupDockingPlateStateError(FLATFoupDockingPlate owner) : base(owner)
        {
        }
