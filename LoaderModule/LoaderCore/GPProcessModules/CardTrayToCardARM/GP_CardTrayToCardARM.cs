...
namespace LoaderCore
{
    ...
    using LogModule;
    using LoaderBase;
    using LoaderCore.GP_CardBufferTrayToCardARMStates;

    public partial class GP_CardTrayToCardARM : ILoaderProcessModule
    {
        public GP_CardTrayToCardARMState StateObj { get; set; }
        ...
        public bool CanExecute(ILoaderProcessParam param)
        {
            ...
            return
                mypa != null &&
                mypa.Curr is ICardBufferTrayModule &&
