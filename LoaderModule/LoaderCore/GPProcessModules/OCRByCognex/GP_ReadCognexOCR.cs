...
namespace LoaderCore
{
    ...
    using LogModule;
    using LoaderBase;
    using LoaderCore.GP_ReadCognexOCRStates;

    public partial class GP_ReadCognexOCR : ILoaderProcessModule
    {
        public GP_ReadCognexOCRState StateObj { get; set; }
