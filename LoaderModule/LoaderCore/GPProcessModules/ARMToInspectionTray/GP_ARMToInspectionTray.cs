...
namespace LoaderCore
{
    ...
    using LogModule;
    using LoaderBase;
    using LoaderCore.GP_ARMToInspectionTrayStates;

    public partial class GP_ARMToInspectionTray : ILoaderProcessModule
    {
        public GP_ARMToInspectionTrayState StateObj { get; set; }
        ...
        public bool CanExecute(ILoaderProcessParam param)
        {
            ...
            return
                ...
                mypa.Next is IInspectionTrayModule &&
