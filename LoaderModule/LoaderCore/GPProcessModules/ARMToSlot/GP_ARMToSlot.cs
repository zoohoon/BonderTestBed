...
namespace LoaderCore
{
    ...
    using LogModule;
    using LoaderBase;
    using LoaderCore.GP_ARMToSlotStates;

    public partial class GP_ARMToSlot : ILoaderProcessModule
    {
        public GP_ARMToSlotState StateObj { get; set; }
