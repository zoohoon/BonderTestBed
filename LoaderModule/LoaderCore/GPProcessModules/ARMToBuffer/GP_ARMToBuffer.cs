...
namespace LoaderCore
{
    ...
    using LogModule;
    using LoaderCore.GP_ARMToBufferStates;

    public partial class GP_ARMToBuffer : ILoaderProcessModule
    {
        public GP_ARMToBufferState StateObj { get; set; }
