...
namespace LoaderCore
{
    ...
    using LogModule;
    using LoaderBase;
    using LoaderCore.GP_CardARMToCardTrayStates;

    public partial class GP_CardARMToCardTray : ILoaderProcessModule
    {
        public GP_CardARMToCardTrayState StateObj { get; set; }
        ...
        public bool CanExecute(ILoaderProcessParam param)
        {
            ...
            return
                ...
                mypa.Next is ICardBufferTrayModule &&
