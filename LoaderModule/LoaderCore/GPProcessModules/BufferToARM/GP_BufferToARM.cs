...
namespace LoaderCore
{
    ...
    using LogModule;
    using LoaderBase;
    using LoaderCore.GP_BufferToARMStates;

    public partial class GP_BufferToARM : ILoaderProcessModule
    {
        public GP_BufferToARMState StateObj { get; set; }
