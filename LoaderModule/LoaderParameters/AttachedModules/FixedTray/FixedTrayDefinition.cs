...
{
    /// <summary>
    /// FixedTray의 특성을 정의합니다.
    /// </summary>
    [DataContract]
    [Serializable]
    public class FixedTrayDefinition : INotifyPropertyChanged, ICloneable, IParamNode
    {
        ...
        private Element<bool> _CanUseBuffer = new Element<bool>();
        /// <summary>
        /// Fixed Tray Holder를 Buffer로 사용할 수 있게합니다.
        /// </summary>
        [DataMember]
        public Element<bool> CanUseBuffer
        {
        ...
        private ObservableCollection<FixedTrayAccessParam> _AccessParams;
        /// <summary>
        /// FixedTray에 Access하기 위한 파라미터를 가져오거나 설정합니다.
        /// </summary>
        [DataMember]
        public ObservableCollection<FixedTrayAccessParam> AccessParams
        {
        ...
        public FixedTrayDefinition()
        {
            try
            {
            _DIWAFERONMODULE.Value = string.Empty;
            _IOCheckDelayTimeout.Value = 500;
            _AccessParams = new ObservableCollection<FixedTrayAccessParam>();
            }
            catch (Exception err)
            {
        ...
        public object Clone()
        {
            ...
            var shallowClone = MemberwiseClone() as FixedTrayDefinition;
    ...
    /// <summary>
    /// FixedTray에 Access하기위한 파라미터를 정의합니다.
    /// </summary>
    [DataContract]
    [Serializable]
    public class FixedTrayAccessParam : INotifyPropertyChanged, ICloneable, IParamNode
    {
        [XmlIgnore, JsonIgnore]
        public string Genealogy { get; set; }
        [NonSerialized]
        ...
        public object Clone()
        {
            try
            {
                var shallowClone = MemberwiseClone() as FixedTrayAccessParam;
