...
namespace LoaderParameters
{
    ...
    [Serializable]
    [DataContract]
    public class CardARMDefinition : INotifyPropertyChanged, ICloneable, IParamNode
    {
        ...
        private Element<string> _DOAIROFF = new Element<string>();
        /// <summary>
        /// Air를 켜거나 끄는 Output Description을 가져오거나 설정합니다.
        /// </summary>
        [DataMember]
        public Element<string> DOAIROFF
        {
            get { return _DOAIROFF; }
            set { _DOAIROFF = value; RaisePropertyChanged(); }
        }
        private Element<string> _DICARDEXIST = new Element<string>();
        /// <summary>
        /// Wafer가 있는 지 검사하는 Input Description을 가져오거나 설정합니다.
        /// </summary>
        [DataMember]
        public Element<string> DICARDEXIST
        {
            get { return _DICARDEXIST; }
            set { _DICARDEXIST = value; RaisePropertyChanged(); }
        }

        public CardARMDefinition()
        {
            try
            {
    ...
    [DataContract]
    [Serializable]
    public class CardArmAccessParam : INotifyPropertyChanged, ICloneable, IParamNode
    {
        [XmlIgnore, JsonIgnore]
        public string Genealogy { get; set; }
        [NonSerialized]
