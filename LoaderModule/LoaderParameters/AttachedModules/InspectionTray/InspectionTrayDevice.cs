...
{
    /// <summary>
    /// InspectionTray의 디바이스를 정의합니다.
    /// </summary>
    [DataContract]
    [Serializable]
    [KnownType(typeof(IElement))]
    public class InspectionTrayDevice : INotifyPropertyChanged, ICloneable, IParamNode
    {
        ...
        /// <summary>
        /// InspectionTray에서 할당되는 오브젝트의 디바이스 정보를 가져오거나 설정합니다.
        /// </summary>
        [DataMember]
        ...
        public object Clone()
        {
            try
            {
                var shallowClone = MemberwiseClone() as InspectionTrayDevice;
