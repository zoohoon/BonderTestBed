...
{
    /// <summary>
    /// CardBufferTray의 디바이스를 정의합니다.
    /// </summary>
    [DataContract]
    [Serializable]
    public class CardBufferTrayDevice : INotifyPropertyChanged, ICloneable, IParamNode
    {
        ...
        /// <summary>
        /// CardBufferTray에서 할당되는 오브젝트의 디바이스 정보를 가져오거나 설정합니다.
        /// </summary>
        [DataMember]
        ...
        public object Clone()
        {
            var shallowClone = MemberwiseClone() as CardBufferTrayDevice;
    ...
    [DataContract]
    [Serializable]
    public class CardBufferDevice : INotifyPropertyChanged, ICloneable, IParamNode
    {
        [XmlIgnore, JsonIgnore]
        public string Genealogy { get; set; }
        [NonSerialized]
