...
namespace LoaderBase
{
    ...
    /// ARM을 정의합니다.
    /// </summary>
    public interface IARMModule : IWaferOwnable, IAttachedModule
    {
        /// <summary>
        /// 모듈 정의 파라미터를 가져옵니다.
        /// </summary>
        ARMDefinition Definition { get; }

        /// <summary>
        /// 디바이스 파라미터를 가져옵니다.
        /// </summary>
        ARMDevice Device { get; }
        ...
        EventCodeEnum SetDefinition(ARMDefinition definition, int index);
        ...
        /// <returns></returns>
        EventCodeEnum SetDevice(ARMDevice device);
