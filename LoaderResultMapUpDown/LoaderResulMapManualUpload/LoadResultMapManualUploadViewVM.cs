...
{
    public class LoadResultMapManualUploadViewVM : INotifyPropertyChanged
    {
        /// <summary>
        /// ManualUpload 창의 viewer model class
        /// </summary>
        ...
        private ObservableCollection<ManualUploadItem> _ResultMapList = new ObservableCollection<ManualUploadItem>();
        ...
        /// 생성자
        /// </summary>
        /// <param name="myWnd">view의 window </param>
        /// <param name="spoolingMng">spooling manager</param>
        public LoadResultMapManualUploadViewVM(Window myWnd, SpoolingManager spoolingMng)
        {
            parentWnd = myWnd;
        ...
        {
            get { return _ResultMapList; }
            set
            {
                if (value != _ResultMapList)
                {
                    _ResultMapList = value;
                    RaisePropertyChanged();
                }
            }
        }
        ...
        public void ShowMaualUploadDlg()
        {
            try
            {
                LoaderResultMapManualUploadDlg wnd = parentWnd as LoaderResultMapManualUploadDlg;
        ...
        /// </summary>
        public void ResultMapItemListUp()
        {
            _ResultMapList.Clear();
            progressPos = 0;
        ...
        public ICommand ManualUploadStart
        {
            ...
            {
                if (null == _UploadCmd)
                    _UploadCmd = new DelegateCommand(ResultMapUploadStart, CanExecuteMethod);
                return _UploadCmd;
            }
        }
        ...
        private void ResultMapUploadStart(object obj)
        {
            LoggerManager.Debug($" Execute [{MethodBase.GetCurrentMethod().Name}] async generic command.");
            LoaderResultMapManualUploadDlg wnd = obj as LoaderResultMapManualUploadDlg;
...
#pragma warning disable 4014
            //brett// task(result map upload) 실행 후 대기 하지 않고 command 종료 하기 위해 await 하지 않음
            ResultMapUploadProc(obj);
#pragma warning restore 4014
        ...
        private async Task ResultMapUploadProc(object obj)
        {
            try
            {
                LoaderResultMapManualUploadDlg wnd = obj as LoaderResultMapManualUploadDlg;
