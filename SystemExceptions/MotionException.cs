...
namespace SystemExceptions.MotionException
{
    public class MotionException : Exception
    {
        ...
        //public MotionException(string message, object classname) : base("Class: " + classname.GetType().ToString() + " " + message)
        //{
        //}

        //public MotionException(string message, Exception innerException) : base(message, innerException)
        //{
        //    try
        //    {
        ...
        public MotionException(string message, EventCodeEnum errorcode)
        {
            try
            {
                ErrorCode = errorcode;
        ...
        public MotionException(string message, Exception innerException, EventCodeEnum errorcode) :
        ...
        public MotionException(string message, Exception innerException, EventCodeEnum errorcode, int returnvalue, object classname) :
        ...
        public MotionException(string message, Exception innerException, EventCodeEnum errorcode, object classname) :
        ...
        //protected MotionException(SerializationInfo info, StreamingContext context) : base(info, context)
        //{
        //}
    }
