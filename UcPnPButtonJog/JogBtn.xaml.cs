...
namespace UcPnPButtonJog
{
    ...
    public partial class JogBtn : UserControl, ICUIControl, INotifyPropertyChanged
    {
        ...
        public Guid GUID { get; set; } = new Guid("3455C399-9C8F-E9BC-0394-58FDFB04CDB1");
        ...
        public JogBtn()
        {
            ...
            {
                InitializeComponent();
                Binding bindCaption = new Binding();
                bindCaption.Path = new PropertyPath("Caption");
                bindCaption.Source = this;
                BindingOperations.SetBinding(textBlock, TextBlock.TextProperty, bindCaption);
                ...
                BindingOperations.SetBinding(
                    btnImageEffect,
                    DropShadowBitmapEffect.SoftnessProperty,
                    bindImageSoftness);

                CaptionSize = 1;
                Binding bindCaptionSize = new Binding();
                bindCaptionSize.Path = new PropertyPath("CaptionSize");
                bindCaptionSize.Source = this;
                BindingOperations.SetBinding(textBlock, TextBlock.FontSizeProperty, bindCaptionSize);
            }
            catch (Exception err)
            {
            ...
            //Binding bindCaptionSize = new Binding();
            //bindCaption.Path = new PropertyPath("CaptionSize");
            //bindCaption.Source = this;
            //BindingOperations.SetBinding(textBlock, TextBlock.TextProperty, bindCaptionSize);
        }
