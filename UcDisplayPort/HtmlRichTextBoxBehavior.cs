...
{
    /// <summary>
    /// HTML 형식의 텍스트의 태그를 읽어 색상 폰트 등을 지정 하는 속성
    /// </summary>
    public class HtmlRichTextBoxBehavior : DependencyObject
    {
          ...
          DependencyPropertyChangedEventArgs e)
        {
            ...
            richTextBox.Opacity = string.IsNullOrEmpty(text) ? 0.0 : 1.0;//  Visibility.Hidden : Visibility.Visible;
            ...
            flowDocument.TextAlignment = TextAlignment.Center; //정렬 가운데 정렬로 설정함. 
