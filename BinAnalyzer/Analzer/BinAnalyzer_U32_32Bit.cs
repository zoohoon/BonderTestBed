...
{
    internal class BinAnalyzer_U32_32Bit : BinAnalyzerBase
    {
            ...
            try
            {
                for (int i = 0; i < resultCode.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (BinGlobalValidation.BIN_U32_32BIT == sbResultCode.Length)
                        {
                            ...
                            {
                                this.HardBinData.UserBinDictionary.Add(resultCodeUnit, 0);
                            }
                            else
                            {
