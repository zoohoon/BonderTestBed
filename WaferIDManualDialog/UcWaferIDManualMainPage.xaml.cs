...
namespace WaferIDManualDialog
{
    ...
    /// </summary>
    public partial class UcWaferIDManualMainPage : UserControl, IMainScreenView
    {
        readonly Guid _ViewGUID = new Guid("d2b735bc-45fb-4587-94d2-fda5894501be");
        public Guid ScreenGUID { get { return _ViewGUID; } }
        public UcWaferIDManualMainPage()
        {
            InitializeComponent();
