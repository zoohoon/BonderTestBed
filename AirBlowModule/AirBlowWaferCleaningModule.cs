...
{
    public class AirBlowWaferCleaningModule : IAirBlowWaferCleaningModule, INotifyPropertyChanged,
                                                IHasDevParameterizable, IHasSysParameterizable
    {
        ...
        private ReasonOfError _ReasonOfError = new ReasonOfError(ModuleEnum.AirBlowWaferCleaning);
        ...
        private AirBlowWaferCleaningStateBase _WaferAirBlowState;

        public AirBlowWaferCleaningStateBase WaferAirBlowState
        {
            get { return _WaferAirBlowState; }
        }
        public IInnerState InnerState
        {
            ...
            set
            {
                if (value != _WaferAirBlowState)
                {
                    _WaferAirBlowState = value as AirBlowWaferCleaningStateBase;
                }
            }
        }
        ...
        private EnumWaferState _PrevWaferState;

        public EnumWaferState PrevWaferState
        {
            get { return _PrevWaferState; }
            set { _PrevWaferState = value; }
        }
        ...
        private DateTime _PinAlignDoneTime = DateTime.Now;
        public DateTime PinAlignDoneTime
        {
            get { return _PinAlignDoneTime; }
            set
            {
                if (value != _PinAlignDoneTime)
                {
                    _PinAlignDoneTime = value;
                    RaisePropertyChanged();
                }
            }
        }
        ...
        public string GetModuleMessage()
        {
            ...
            try
            {
                EnumWaferAirBlowCleaningState state = (InnerState as AirBlowWaferCleaningStateBase).GetState();
        ...
        public EventCodeEnum InitModule()
        {
            ...
            try
            {
                if (Initialized == false)
                {
                    ...
                    _WaferAirBlowState = new AirBlowWaferCleaningIdleState(this);
        ...
        public EventCodeEnum InnerStateTransition(IInnerState state)
        {
            ...
            try
            {
                ...
                PreInnerState = _WaferAirBlowState;
                InnerState = state;
        ...
        public EventCodeEnum LoadAirBlowDeviceFile()
        {
            ...
            try
            {
                ...
                {
                    RetVal = EventCodeEnum.PARAM_ERROR;
                    //LoggerManager.Error($String.Format("[AirBlowCleaning] LoadDevParam(): Error occurred while loading parameters. Err = {0}", err.Message));
                    LoggerManager.Exception(err);
                }
            }
            catch (Exception err)
        ...
        public EventCodeEnum SaveABDeviceFile()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (RetVal != EventCodeEnum.NONE)
                    {
                        throw new Exception($"[{this.GetType().Name} - SaveABDeviceFile] Faile SaveParameter");
                    }
                }
                catch (Exception err)
                {
                    ...
                    LoggerManager.Exception(err);
                    //LoggerManager.Error($String.Format("[AirBlowCleaningModule] SaveABDeviceFile(): Serialize Error. Err = {0}", err.Message));
                    throw;
                }
            }
            catch (Exception err)
        ...
        public EventCodeEnum LoadAirBlowSysFile()
        {
            ...
            try
            {
                ...
                {
                    RetVal = EventCodeEnum.PARAM_ERROR;
                    //LoggerManager.Error($String.Format("[AirBlowCleaning] LoadSysParam(): Error occurred while loading parameters. Err = {0}", err.Message));
                    LoggerManager.Exception(err);
                }
            }
            catch (Exception err)
        ...
        public bool CanExecute(IProbeCommandToken token)
        {
            ...
            try
            {
                isInjected = _WaferAirBlowState.CanExecute(token);
            }
            catch (Exception err)
            {
                LoggerManager.Exception(err);
