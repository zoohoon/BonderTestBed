namespace GPLoaderRouter.RobotCommands
{
    ...
    public class Buffer_Pick : GPLoaderRobotCommand
    {
        public Buffer_Pick()
        {
            CommandName = EnumRobotCommand.BUFF_PICK;
            ...
            try
            {
                switch (SystemManager.SystemType)
                {
                    ...
                    case SystemTypeEnum.Opera:
                        ...
                        CommandSequence.Add(20, new List<SequenceBehavior>() { new Move_PickPos_LT_LW() });
                        CommandSequence.Add(30, new List<SequenceBehavior>() { new Move_TargetPos_Arm(),
                                                                               new Vac_On_Arm() });
                        CommandSequence.Add(40, new List<SequenceBehavior>() { new Move_Down_LT(),
