namespace GPLoaderRouter.RobotCommands
{
    ...
    public class FixedTray_Put : GPLoaderRobotCommand
    {
        public FixedTray_Put()
        {
            CommandName = EnumRobotCommand.FT_PUT;
            ...
            try
            {
                switch (SystemManager.SystemType)
                {
                    ...
                    case SystemTypeEnum.Opera:
                        ...
                        CommandSequence.Add(20, new List<SequenceBehavior>() { new CheckVac_Target_BeforePut(),
